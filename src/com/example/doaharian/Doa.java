...
public class Doa extends ListActivity {
	public void onCreate(Bundle icicle) {
		...
		String[] Doa = new String[] { "Do'a Akan Makan", "Do'a Sesudah Makan","Do'a Akan Tidur", "Do'a Bangun Tidur", "Do'a Masuk Masjid","Do'a Keluar Masjid","Do'a Masuk Rumah","Do'a Keluar Rumah","Do'a Masuk Toilet", "Do'a Keluar Toilet" };
		...
		this.setListAdapter(new ArrayAdapter<String>(this,
				...
				getListView().setBackgroundResource(R.drawable.backdrop_menu);
